...
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.TURN_TOWARD_VORTEX_AGAIN;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.BACK_UP_FROM_BEACON1;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.BACK_UP_FROM_BEACON2;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.CHECK_COLOR_AMOUNTS;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.CHECK_COLOR_AMOUNTS2;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.CHECK_COLOR_LOGIC1;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.CHECK_COLOR_LOGIC2;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.DRIVE_QUICKLY_STRAIGHT_TO_LINE;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.DRIVE_SLOWLY_TILL_FIND_LINE;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.DRIVE_STRAIGHT_FROM_WALL;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.DRIVE_TILL_TOUCH;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.DRIVE_TILL_TOUCH2;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.DRIVE_TO_VORTEX;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.MOVE_LEFT;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.MOVE_LEFT2;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.MOVE_RIGHT;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.MOVE_RIGHT2;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.RECOVERY;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.SLIDE_SLOWLY_TILL_LINE;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.SLIDE_TO_OTHER_BEACON;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.STOP3;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.STOP4;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.STOP_AFTER_BACKING_UP;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.STOP_FINAL;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.STOP_ON_LINE;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.STOP_ON_WALL;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.STOP_RESET_CAPTURE_POSITION;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.TBD_CODE;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.TURN_TOWARD_LINE;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.TURN_TOWARD_VORTEX;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.TURN_TOWARD_WALL;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.WAIT_FOR_PUSH1;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.WAIT_FOR_PUSH2;
import static org.firstinspires.ftc.teamcode.beaconAutonomousREDLinearSlideShorterRevA2_7_shootFirst.State.SHOOT_BALLS;

@Autonomous(name="Beacon Red shoot", group="Beacon")
    ...
    beacon2.enableLed(false);
      ...
      switch (state) {
        ...
        case DRIVE_STRAIGHT_FROM_WALL:
            balllauncher1.setPower(0.5);
            balllauncher2.setPower(0.5);
          ...
          case TURN_TOWARD_VORTEX_AGAIN:
              ...
              if (gyro.getHeading() < 180 && gyro.getHeading()>6) {   //the <180 is to compensate if the robot turns slightly to the left
                  state = SHOOT_BALLS;
                  left_set_power(0.0);
                  right_set_power(0.0);
                  pointTurn("RUE", 0, "r", 0);
        ...
        case TURN_TOWARD_LINE:
            ...
            if (gyro.getHeading()<337 && gyro.getHeading()>180) {   //the <180 is to compensate if the robot turns slightly to the left
        ...
        case TURN_TOWARD_WALL:
            ...
            if (gyro.getHeading()<281 && gyro.getHeading()>180) {
                state = STOP4;
            }
            break;
        case STOP4:
