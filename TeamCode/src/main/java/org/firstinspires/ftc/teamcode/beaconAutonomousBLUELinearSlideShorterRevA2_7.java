...
import static org.firstinspires.ftc.teamcode.beaconAutonomousBLUELinearSlideShorterRevA2_7.State.BACK_UP_FROM_BEACON1;
import static org.firstinspires.ftc.teamcode.beaconAutonomousBLUELinearSlideShorterRevA2_7.State.BACK_UP_FROM_BEACON2;
import static org.firstinspires.ftc.teamcode.beaconAutonomousBLUELinearSlideShorterRevA2_7.State.CHECK_COLOR_LOGIC1;
import static org.firstinspires.ftc.teamcode.beaconAutonomousBLUELinearSlideShorterRevA2_7.State.CHECK_COLOR_LOGIC2;
import static org.firstinspires.ftc.teamcode.beaconAutonomousBLUELinearSlideShorterRevA2_7.State.DRIVE_QUICKLY_STRAIGHT_TO_LINE;
import static org.firstinspires.ftc.teamcode.beaconAutonomousBLUELinearSlideShorterRevA2_7.State.DRIVE_SLOWLY_TILL_FIND_LINE;
import static org.firstinspires.ftc.teamcode.beaconAutonomousBLUELinearSlideShorterRevA2_7.State.DRIVE_STRAIGHT_FROM_WALL;
import static org.firstinspires.ftc.teamcode.beaconAutonomousBLUELinearSlideShorterRevA2_7.State.DRIVE_TILL_TOUCH;
import static org.firstinspires.ftc.teamcode.beaconAutonomousBLUELinearSlideShorterRevA2_7.State.DRIVE_TILL_TOUCH2;
...
import static org.firstinspires.ftc.teamcode.beaconAutonomousBLUELinearSlideShorterRevA2_7.State.STOP_ON_WALL;
import static org.firstinspires.ftc.teamcode.beaconAutonomousBLUELinearSlideShorterRevA2_7.State.STOP_RESET_CAPTURE_POSITION;
import static org.firstinspires.ftc.teamcode.beaconAutonomousBLUELinearSlideShorterRevA2_7.State.TURN_TOWARD_LINE;
import static org.firstinspires.ftc.teamcode.beaconAutonomousBLUELinearSlideShorterRevA2_7.State.TURN_TOWARD_VORTEX;
...
import static org.firstinspires.ftc.teamcode.beaconAutonomousBLUELinearSlideShorterRevA2_7.State.MOVE_RIGHT;
import static org.firstinspires.ftc.teamcode.beaconAutonomousBLUELinearSlideShorterRevA2_7.State.CHECK_COLOR_AMOUNTS;

import static org.firstinspires.ftc.teamcode.beaconAutonomousBLUELinearSlideShorterRevA2_7.State.MOVE_LEFT2;
import static org.firstinspires.ftc.teamcode.beaconAutonomousBLUELinearSlideShorterRevA2_7.State.MOVE_RIGHT2;
import static org.firstinspires.ftc.teamcode.beaconAutonomousBLUELinearSlideShorterRevA2_7.State.CHECK_COLOR_AMOUNTS2;

@Autonomous(name="Beacon Blue Center", group="Beacon")
    ...
    beacon2.enableLed(false);
      ...
      switch (state) {
        ...
        case TURN_TOWARD_LINE:
            ...
            if (gyro.getHeading() > 33 && gyro.getHeading() < 180) {
        ...
        case TURN_TOWARD_VORTEX:              // turn slightly to face center vortex
            ...
            if (gyro.getHeading() < 65 && gyro.getHeading() > 1) {
