...
@Autonomous(name="Shoot Ball NO CENTER", group="Center")

public class ballShootAuto3D_Print_Tube_NOCENTER extends Error404_Hardware_Tier2

{
  ...
  private int test=0;
  public ballShootAuto3D_Print_Tube_NOCENTER()
  {
  }
  ...
  @Override public void loop ()
  {
    switch (state)
    {
      case 0:
        ...
        if (is_encoder_reached((2000+encoder), leftFront)) {
            driveStright("RUE", 0, "f", 0);
            state++;
            encoder=balllauncher1.getCurrentPosition();
        }
        case 2:
            balllauncher1.setPower(0.4);
            balllauncher2.setPower(0.4);
